...
const Savings = (props) => {
  ...
  const [sVal, setSVal] = React.useState("Deposit");
  ...
  const contStartTimerStart = () => {
    let countDownDate = new Date('April 10,2021 00:00:00').getTime()
  ...
  return (
    ...
    >
      ...
      {/* no Delete  thsis code this is original Code of component */}
              ...
              <Paper className={classes.mintFirstCardContainer}>
                ...
                <div style={{ marginTop: 30 }}>
                  <Typography style={{ fontSize: 15 }}>
                    ...
                    levied during the withdrawal. Considering the current APY
                    the breakeven time is approximately 6 days 1 hours
                  </Typography>
                </div>
              </Paper>
            </Grid>
